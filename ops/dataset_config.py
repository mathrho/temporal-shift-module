...
ROOT_DATASET = '/export/sdb/home/lizhenyang8/data/'  # '/data/jilin/'
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'kinetics-400/compress'
        ...
        prefix = 'img_{:05d}.jpg'
        #root_data = ROOT_DATASET + 'kinetics/data/val_full_frames'
